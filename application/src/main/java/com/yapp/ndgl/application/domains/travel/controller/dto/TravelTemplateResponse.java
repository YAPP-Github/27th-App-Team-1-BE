...
public record TravelTemplateResponse(
    @Schema(description = "여행 템플릿 ID", example = "Unique_ID_문자열", requiredMode = Schema.RequiredMode.REQUIRED)
    String travelId,
    ...
    String city,
    @Schema(description = "현지 날씨 및 복장 정보", example = "여름철 고온다습, 가벼운 옷차림 권장", nullable = true)
    String weatherInfo,
    @Schema(description = "문화적 주의사항 및 에티켓", example = "식당에서 팁 불필요, 조용히 식사하는 것이 예의", nullable = true)
    String cultureInfo,
    @Schema(description = "전반적인 음식 관련 특징", example = "라멘과 초밥이 유명하며, 현지 식당에서 현금 결제가 일반적", nullable = true)
    String foodInfo,
    @Schema(description = "썸네일 이미지 URL", example = "https://example.com/thumbnail.jpg", nullable = true)
    String thumbnail,
    @Schema(description = "유튜브 링크", example = "https://www.youtube.com/watch?v=example", nullable = true)
    String link,
    @Schema(description = "1인 기준 총 예산 (원)", example = "1000000", nullable = true)
    Integer budgetPerPerson,
    @Schema(description = "영상 요약", example = "도쿄 여행의 모든 것", requiredMode = Schema.RequiredMode.REQUIRED)
    String summary,
    @Schema(description = "제목", example = "도쿄 3박 4일 여행 가이드", requiredMode = Schema.RequiredMode.REQUIRED)
    String title,
    ...
    Integer days,
    @Schema(description = "여행 템플릿에 포함된 장소 목록", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    public record PlaceResponse(
        ...
        Double longitude,
        @Schema(description = "평점", example = "4.5", nullable = true)
        Double rating,
        @Schema(description = "국내 전화번호", example = "03-1234-5678", nullable = true)
        String nationalPhoneNumber,
        @Schema(description = "국제 전화번호", example = "+81-3-1234-5678", nullable = true)
        String internationalPhoneNumber,
        @Schema(description = "웹사이트 URI", example = "https://example.com", nullable = true)
        String websiteUri,
        @Schema(description = "Google Maps URI", example = "https://maps.google.com/?cid=123456", nullable = true)
